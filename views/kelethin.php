<table width=95% border="0" cellpadding="0" cellspacing="5" align="center">
  <tr>
    <td colspan="3">
      <h1 align: left><font size=+7>K</font>ELETHIN</h1>
      <table cellpadding=10 width=90%>
        <tr>
          <th>Location:</th>
          <td>In the trees of the Greater Faydark forest on the northern half
            of the continent of Faydwer</td>
          <td rowspan=5 width="200"><a href="/map/kelethin"><img src="/images/kelethinsmall.jpg" border="0" width="95" height="112"></a><br>
            <center>
              <p><b>click to view expanded map</b><b>...</b> </p>
            </center>
            </td>
        </tr>
        <tr>
          <th>Races:</th>
          <td>Wood Elf, Half-Elves</td>
        </tr>
        <tr>
          <th>Guilds:</th>
          <td>Bard, Druid, Ranger, Rogue, Warrior</td>
        </tr>
        <tr>
      ...
      <p>
        <b>Project1999 Links:</b> <a href="https://wiki.project1999.com/Kelethin#What.27s_in_this_zone.3F" target="_blank">What's in this zone?</a>
      </p>
      <h3><font size=+2>D</font>escription</h3>
      <p>Kelethin is one of the most amazing cities in all of Norrath, a tree
      ...
      <p>The area surrounding Kelethin is swarming with life. Black wolves, wasp
      ...
      <p>Further from the main city lies the entrance to Crushbone itself. The
      ...
      <h3><font size=+2>T</font>ravelling <font size=+2>T</font>o and <font size=+2>F</font>rom
        <font size=+2>K</font>elethin</h3>
      <p>Kelethin is one of the four major cities on the continent of Faydwer,
        ...
        Mountains.
      <p>As far as travelling abroad, Kelethin is about as far from a port as
      ...
      <p><b>Places</b>
      <p>The city itself is really the site to see when you are in Kelethin. It
      ...
      <p><b>People</b>
      <p>The people of Kelethin are a quiet folk. They are sequestered away in
